...
public abstract class DAO {
	...
	/**
	 * Returns a new DAO instance given the source string. For IMAP DAO
	 * the source string format should be: IMAP:username:password and for 
	 * the file system DAO: FileSystems:path.
	 ...
	 * @param limit The limit on the number of emails.
