                ...
                if(m && m[1]) {
                    ...
                    switch(action) {
                        ...
                        case "arl": //applying label
                            ...
                            console.log("Apply label " + urlParams["acn"]);

                            /*
                            //TODO: support emails from query
                            if (urlParams['search'] == 'inbox'){
                                console.log("label is applied to email from inbox");
                            }else if (urlParams['search'] == 'cat'){
                                var cat = urlParams["cat"];
                                console.log("label is applied to email from " + cat);
                            }
                            */
                            var emails = postParams['t'] instanceof Array ? postParams['t'] : [ postParams['t'] ];
                            console.log(emails);
